...
export function getNst(): number {
  return nstChildStack[nstChildStack.length - 1];
}

export function increaseNstChild() {
  nstChildStack[nstChildStack.length - 1]++;
  console.log(nstChildStack);
}
